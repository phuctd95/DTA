...
int main(int argc, char ** argv)
{
        ...
        if (strcmp(alg, "SRA") == 0){
                SRA(std::bind(&sampler_f::feature_polling, &sam, _1, _2, _3, _4), seeds, t, epsilon,delta,n*1.0);
        } else if (strcmp(alg, "DTA") == 0){
                DTA(std::bind(&sampler_f::feature_polling, &sam, _1, _2, _3, _4),seeds,t,epsilon,delta,n*1.0);
        }
}
